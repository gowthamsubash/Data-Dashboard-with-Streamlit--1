...
@author: Gowtham Subash B

This project is built in the process of learning streamlit in #30 days of learning streamlit challenge
"""
...
@st.cache # Stores data in cache and avoid reloading data
def load_data():
